...
public class AllRegActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.all_registrations);
    ...
    private void populateScrollView() {
        ...
        try {
            ...
            if (cursor != null && cursor.getCount() > 0) {
                ...
                // Add column headers
                String[] headers = {"Class ID", "Reg Status", "Attendee ID", "First Name", "Last Name"};
